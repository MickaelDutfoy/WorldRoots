class Spell {
    static grimoire = {
        ...
        buffStrength1: new Spell("Renforcement", "buffStrength1", 10, "buff", 3, "none", "all"),
        buffStrength2: new Spell("Renforcement +", "buffStrength2", 20, "buff", 6, "none", "all"),
        buffStrength3: new Spell("Renforcement α", "buffStrength3", 30, "buff", 9, "none", "all"),
        buffStrength4: new Spell("Renforcement β", "buffStrength4", 40, "buff", 12, "none", "all"),
        buffStrength5: new Spell("Renforcement X", "buffStrength5", 50, "buff", 15, "none", "all"),
        buffStrength6: new Spell("Renforcement Δ", "buffStrength6", 60, "buff", 18, "none", "all"),
        buffStrength7: new Spell("Renforcement Σ", "buffStrength7", 70, "buff", 21, "none", "all"),
        buffStrength8: new Spell("Renforcement Φ", "buffStrength8", 80, "buff", 24, "none", "all"),
        buffStrength9: new Spell("Renforcement Ω", "buffStrength9", 90, "buff", 27, "none", "all"),
        buffStrength10: new Spell("Renforcement ∞", "buffStrength10", 100, "buff", 30, "none", "all"),

        debuffStrength1: new Spell("Faiblesse", "debuffStrength1", 10, "debuff", 3, "none", "all"),
        debuffStrength2: new Spell("Faiblesse +", "debuffStrength2", 20, "debuff", 6, "none", "all"),
        debuffStrength3: new Spell("Faiblesse α", "debuffStrength3", 30, "debuff", 9, "none", "all"),
        debuffStrength4: new Spell("Faiblesse β", "debuffStrength4", 40, "debuff", 12, "none", "all"),
        debuffStrength5: new Spell("Faiblesse X", "debuffStrength5", 50, "debuff", 15, "none", "all"),
        debuffStrength6: new Spell("Faiblesse Δ", "debuffStrength6", 60, "debuff", 18, "none", "all"),
        debuffStrength7: new Spell("Faiblesse Σ", "debuffStrength7", 70, "debuff", 21, "none", "all"),
        debuffStrength8: new Spell("Faiblesse Φ", "debuffStrength8", 80, "debuff", 24, "none", "all"),
        debuffStrength9: new Spell("Faiblesse Ω", "debuffStrength9", 90, "debuff", 27, "none", "all"),
        debuffStrength10: new Spell("Faiblesse ∞", "debuffStrength10", 100, "debuff", 30, "none", "all"),

        buffAgility1: new Spell("Célérité", "buffAgility1", 10, "buff", 3, "none", "all"),
        buffAgility2: new Spell("Célérité +", "buffAgility2", 20, "buff", 6, "none", "all"),
        buffAgility3: new Spell("Célérité α", "buffAgility3", 30, "buff", 9, "none", "all"),
        buffAgility4: new Spell("Célérité β", "buffAgility4", 40, "buff", 12, "none", "all"),
        buffAgility5: new Spell("Célérité X", "buffAgility5", 50, "buff", 15, "none", "all"),
        buffAgility6: new Spell("Célérité Δ", "buffAgility6", 60, "buff", 18, "none", "all"),
        buffAgility7: new Spell("Célérité Σ", "buffAgility7", 70, "buff", 21, "none", "all"),
        buffAgility8: new Spell("Célérité Φ", "buffAgility8", 80, "buff", 24, "none", "all"),
        buffAgility9: new Spell("Célérité Ω", "buffAgility9", 90, "buff", 27, "none", "all"),
        buffAgility10: new Spell("Célérité ∞", "buffAgility10", 100, "buff", 30, "none", "all"),

        debuffAgility1: new Spell("Maladresse", "debuffAgility1", 10, "debuff", 3, "none", "all"),
        debuffAgility2: new Spell("Maladresse +", "debuffAgility2", 20, "debuff", 6, "none", "all"),
        debuffAgility3: new Spell("Maladresse α", "debuffAgility3", 30, "debuff", 9, "none", "all"),
        debuffAgility4: new Spell("Maladresse β", "debuffAgility4", 40, "debuff", 12, "none", "all"),
        debuffAgility5: new Spell("Maladresse X", "debuffAgility5", 50, "debuff", 15, "none", "all"),
        debuffAgility6: new Spell("Maladresse Δ", "debuffAgility6", 60, "debuff", 18, "none", "all"),
        debuffAgility7: new Spell("Maladresse Σ", "debuffAgility7", 70, "debuff", 21, "none", "all"),
        debuffAgility8: new Spell("Maladresse Φ", "debuffAgility8", 80, "debuff", 24, "none", "all"),
        debuffAgility9: new Spell("Maladresse Ω", "debuffAgility9", 90, "debuff", 27, "none", "all"),
        debuffAgility10: new Spell("Maladresse ∞", "debuffAgility10", 100, "debuff", 30, "none", "all"),

        buffIntelligence1: new Spell("Clairvoyance", "buffIntelligence1", 10, "buff", 3, "none", "all"),
        buffIntelligence2: new Spell("Clairvoyance +", "buffIntelligence2", 20, "buff", 6, "none", "all"),
        buffIntelligence3: new Spell("Clairvoyance α", "buffIntelligence3", 30, "buff", 9, "none", "all"),
        buffIntelligence4: new Spell("Clairvoyance β", "buffIntelligence4", 40, "buff", 12, "none", "all"),
        buffIntelligence5: new Spell("Clairvoyance X", "buffIntelligence5", 50, "buff", 15, "none", "all"),
        buffIntelligence6: new Spell("Clairvoyance Δ", "buffIntelligence6", 60, "buff", 18, "none", "all"),
        buffIntelligence7: new Spell("Clairvoyance Σ", "buffIntelligence7", 70, "buff", 21, "none", "all"),
        buffIntelligence8: new Spell("Clairvoyance Φ", "buffIntelligence8", 80, "buff", 24, "none", "all"),
        buffIntelligence9: new Spell("Clairvoyance Ω", "buffIntelligence9", 90, "buff", 27, "none", "all"),
        buffIntelligence10: new Spell("Clairvoyance ∞", "buffIntelligence10", 100, "buff", 30, "none", "all"),

        debuffIntelligence1: new Spell("Migraine", "debuffIntelligence1", 10, "debuff", 3, "none", "all"),
        debuffIntelligence2: new Spell("Migraine +", "debuffIntelligence2", 20, "debuff", 6, "none", "all"),
        debuffIntelligence3: new Spell("Migraine α", "debuffIntelligence3", 30, "debuff", 9, "none", "all"),
        debuffIntelligence4: new Spell("Migraine β", "debuffIntelligence4", 40, "debuff", 12, "none", "all"),
        debuffIntelligence5: new Spell("Migraine X", "debuffIntelligence5", 50, "debuff", 15, "none", "all"),
        debuffIntelligence6: new Spell("Migraine Δ", "debuffIntelligence6", 60, "debuff", 18, "none", "all"),
        debuffIntelligence7: new Spell("Migraine Σ", "debuffIntelligence7", 70, "debuff", 21, "none", "all"),
        debuffIntelligence8: new Spell("Migraine Φ", "debuffIntelligence8", 80, "debuff", 24, "none", "all"),
        debuffIntelligence9: new Spell("Migraine Ω", "debuffIntelligence9", 90, "debuff", 27, "none", "all"),
        debuffIntelligence10: new Spell("Migraine ∞", "debuffIntelligence10", 100, "debuff", 30, "none", "all"),

        buffVitality1: new Spell("Robustesse", "buffVitality1", 10, "buff", 3, "none", "all"),
        buffVitality2: new Spell("Robustesse +", "buffVitality2", 20, "buff", 6, "none", "all"),
        buffVitality3: new Spell("Robustesse α", "buffVitality3", 30, "buff", 9, "none", "all"),
        buffVitality4: new Spell("Robustesse β", "buffVitality4", 40, "buff", 12, "none", "all"),
        buffVitality5: new Spell("Robustesse X", "buffVitality5", 50, "buff", 15, "none", "all"),
        buffVitality6: new Spell("Robustesse Δ", "buffVitality6", 60, "buff", 18, "none", "all"),
        buffVitality7: new Spell("Robustesse Σ", "buffVitality7", 70, "buff", 21, "none", "all"),
        buffVitality8: new Spell("Robustesse Φ", "buffVitality8", 80, "buff", 24, "none", "all"),
        buffVitality9: new Spell("Robustesse Ω", "buffVitality9", 90, "buff", 27, "none", "all"),
        buffVitality10: new Spell("Robustesse ∞", "buffVitality10", 100, "buff", 30, "none", "all"),

        debuffVitality1: new Spell("Anémie", "debuffVitality1", 10, "debuff", 3, "none", "all"),
        debuffVitality2: new Spell("Anémie +", "debuffVitality2", 20, "debuff", 6, "none", "all"),
        debuffVitality3: new Spell("Anémie α", "debuffVitality3", 30, "debuff", 9, "none", "all"),
        debuffVitality4: new Spell("Anémie β", "debuffVitality4", 40, "debuff", 12, "none", "all"),
        debuffVitality5: new Spell("Anémie X", "debuffVitality5", 50, "debuff", 15, "none", "all"),
        debuffVitality6: new Spell("Anémie Δ", "debuffVitality6", 60, "debuff", 18, "none", "all"),
        debuffVitality7: new Spell("Anémie Σ", "debuffVitality7", 70, "debuff", 21, "none", "all"),
        debuffVitality8: new Spell("Anémie Φ", "debuffVitality8", 80, "debuff", 24, "none", "all"),
        debuffVitality9: new Spell("Anémie Ω", "debuffVitality9", 90, "debuff", 27, "none", "all"),
        debuffVitality10: new Spell("Anémie ∞", "debuffVitality10", 100, "debuff", 30, "none", "all"),

        buffWillpower1: new Spell("Résilience", "buffWillpower1", 10, "buff", 3, "none", "all"),
        buffWillpower2: new Spell("Résilience +", "buffWillpower2", 20, "buff", 6, "none", "all"),
        buffWillpower3: new Spell("Résilience α", "buffWillpower3", 30, "buff", 9, "none", "all"),
        buffWillpower4: new Spell("Résilience β", "buffWillpower4", 40, "buff", 12, "none", "all"),
        buffWillpower5: new Spell("Résilience X", "buffWillpower5", 50, "buff", 15, "none", "all"),
        buffWillpower6: new Spell("Résilience Δ", "buffWillpower6", 60, "buff", 18, "none", "all"),
        buffWillpower7: new Spell("Résilience Σ", "buffWillpower7", 70, "buff", 21, "none", "all"),
        buffWillpower8: new Spell("Résilience Φ", "buffWillpower8", 80, "buff", 24, "none", "all"),
        buffWillpower9: new Spell("Résilience Ω", "buffWillpower9", 90, "buff", 27, "none", "all"),
        buffWillpower10: new Spell("Résilience ∞", "buffWillpower10", 100, "buff", 30, "none", "all"),

        debuffWillpower1: new Spell("Aboulie", "debuffWillpower1", 10, "debuff", 3, "none", "all"),
        debuffWillpower2: new Spell("Aboulie +", "debuffWillpower2", 20, "debuff", 6, "none", "all"),
        debuffWillpower3: new Spell("Aboulie α", "debuffWillpower3", 30, "debuff", 9, "none", "all"),
        debuffWillpower4: new Spell("Aboulie β", "debuffWillpower4", 40, "debuff", 12, "none", "all"),
        debuffWillpower5: new Spell("Aboulie X", "debuffWillpower5", 50, "debuff", 15, "none", "all"),
        debuffWillpower6: new Spell("Aboulie Δ", "debuffWillpower6", 60, "debuff", 18, "none", "all"),
        debuffWillpower7: new Spell("Aboulie Σ", "debuffWillpower7", 70, "debuff", 21, "none", "all"),
        debuffWillpower8: new Spell("Aboulie Φ", "debuffWillpower8", 80, "debuff", 24, "none", "all"),
        debuffWillpower9: new Spell("Aboulie Ω", "debuffWillpower9", 90, "debuff", 27, "none", "all"),
        debuffWillpower10: new Spell("Aboulie ∞", "debuffWillpower10", 100, "debuff", 30, "none", "all"),
    };
